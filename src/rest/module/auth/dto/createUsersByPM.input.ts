...
export const createUsersByPMInputSchema = z.object({
  ...
  role: z.enum([Role.INSPECTION_MANAGER, Role.CLIENT], { message: 'Role must be one of the predefined roles' }),
});

export type ICreateUsersByPMInput = z.input<typeof createUsersByPMInputSchema>;
